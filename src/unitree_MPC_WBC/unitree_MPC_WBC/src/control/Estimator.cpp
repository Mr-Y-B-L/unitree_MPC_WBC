...
Eigen::Matrix<float, 4, 1> Estimator::GetBaseOrientation(){
    
    return  _lowState->get_quat().cast<float>();
    
}
Eigen::Matrix<float, 12, 1> Estimator::GetMotorAngles(){
    Eigen::Matrix<float, 3, 4> q=_lowState->getQ().cast<float>();
    Eigen::Matrix<float, 12, 1> q_;
    q_<<q.col(0)(0),q.col(0)(1),q.col(0)(2),
        q.col(1)(0),q.col(1)(1),q.col(1)(2),
        q.col(2)(0),q.col(2)(1),q.col(2)(2),
        q.col(3)(0),q.col(3)(1),q.col(3)(2);
    return q_;
}
Eigen::Matrix<float, 12, 1> Estimator::GetMotorVelocities(){
    Eigen::Matrix<float, 3, 4> qd=_lowState->getQd().cast<float>();
    Eigen::Matrix<float, 12, 1> qd_;
    qd_<<qd.col(0)(0),qd.col(0)(1),qd.col(0)(2),
        qd.col(1)(0),qd.col(1)(1),qd.col(1)(2),
        qd.col(2)(0),qd.col(2)(1),qd.col(2)(2),
        qd.col(3)(0),qd.col(3)(1),qd.col(3)(2);
    return qd_;
}
Eigen::Matrix<float, 3, 1> Estimator::GetBaseRollPitchYawRate(){
    return _lowState->getRPYD().cast<float>();
}
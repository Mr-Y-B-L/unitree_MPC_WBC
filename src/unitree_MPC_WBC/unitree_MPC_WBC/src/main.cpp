...
int main(int argc, char **argv)
{
    ...
    //ctrlComp->dt = 0.0035; // run at 500hz
    ctrlComp->dt = 0.0035; 
    // ctrlComp->dt = 0.002; 
    ...
    printf("danymic ok");
    ctrlComp->waveGen = new WaveGenerator(0.5, 0.5, Vec4(0, 0.5, 0.5, 0)); // Trot
    //ctrlComp->waveGen = new WaveGenerator(1.1, 0.5, Vec4(0, 0.5, 0.5, 0)); 
    ...
    //ctrlComp->plot->showPlot("F_view");
    // ctrlComp->plot->showPlot("F_R_f");
    // ctrlComp->plot->showPlot("F_L_f");
    // ctrlComp->plot->showPlot("F_R_B");
    // ctrlComp->plot->showPlot("F_L_B");
    ctrlComp->plot->showPlotAll();
    //ctrlComp->plot->showPlot("euler");
    delete ctrlComp;
    return 0;
